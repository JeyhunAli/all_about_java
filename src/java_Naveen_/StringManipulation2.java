...
public class StringManipulation2 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println(str.charAt(str.indexOf("first")+1)+ " -> confirmation of location of 3rd occurance of character ");
		...
		System.out.println(enroll.substring(enroll.indexOf("is")+3, enroll.indexOf(" please")));
