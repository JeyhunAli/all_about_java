...
public class Employee {
	...
	//getters and setters are only for class var 
	// for private methods we have to create separate method as wrapper then 
	//call private method into public to give acces from outside of the class
